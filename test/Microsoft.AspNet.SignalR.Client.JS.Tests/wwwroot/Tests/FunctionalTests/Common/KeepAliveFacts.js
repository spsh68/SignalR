...
testUtilities.nonAzureModule("Transports Common - Keep Alive Functional Tests", testUtilities.transports.longPolling.enabled);
...
testUtilities.nonAzureModule("Transports Common - Keep Alive Functional Tests");
