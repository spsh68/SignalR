...
testUtilities.nonAzureModule("ForeverFrame Functional Tests - Transport is selected appropriately.", testUtilities.transports.foreverFrame.enabled && $.signalR._.ieVersion <= 8);
